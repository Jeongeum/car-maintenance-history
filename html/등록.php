...
<HTML>
	...
	</div><button onClick="setPass1()">등록하기</button> <br><br>
...
<h2>정비내역 등록</h2>
	<div class="base2">
		...
		<button onClick="setPass2()">등록하기</button>
	<br><br>
</div>
...
<script type="text/javascript" src="./js/carApp.js"></script>
  ...
  else if(document.getElementById('pass').value!= pw) {
    alert("비밀번호가 맞지 않습니다.");
  }
		}
		function setPass2() {
